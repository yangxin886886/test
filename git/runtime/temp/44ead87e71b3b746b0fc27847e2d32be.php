<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"D:\phpstudy\PHPTutorial\wwww\git/application/admin\view\activity\create_activity_view.html";i:1564566772;s:82:"D:\phpstudy\PHPTutorial\wwww\git\application\admin\view\public\head_resources.html";i:1563868278;s:84:"D:\phpstudy\PHPTutorial\wwww\git\application\admin\view\public\bottom_resources.html";i:1563266818;}*/ ?>
...
<!--              </div>-->
             <div class="layui-form-item">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="a_start_time"  lay-verify="required" id="a_start_time"  value=" "   class="layui-input">
                </div>
                <label class="layui-form-label">活动结束时间</label>
                <div class="layui-input-inline">
                  <input type="text" name="a_end_time"   lay-verify="required" id="a_end_time"  class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">选座开始时间</label>
                <div class="layui-input-inline">
                  <input type="text" name="x_start_time"  lay-verify="required" id="x_start_time" value=" "   class="layui-input">
                </div>
                <label class="layui-form-label">选座结束时间</label>
                <div class="layui-input-inline">
                  <input type="text" name="x_end_time"    lay-verify="required" id="x_end_time" value=" "   class="layui-input">
                </div>
              </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="a_didian"   lay-verify="required" value=" "   class="layui-input">
                </div>
              </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="a_dizhi"   lay-verify="required" value=" "   class="layui-input">
                </div>
              </div>
...
<!--                  <button class="layui-btn layui-btn-primary" layadmin-event="avartatPreview">查看图片</button >-->
              ...
              <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <button data-type="set_wx_public"></button>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="wx_name" value=""   class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="wx_keys"   value=""   class="layui-input">
                    </div>
                </div>
...
<script src="/public/layuiadmin/js/jquery-3.1.1.min.js"></script>
  ...
  layui.config({
    ...
    form.on('submit(*)',function(data){
        admin.req({
            url:"<?php echo url('Activity/createActivityAdd'); ?>"
            ,data: data.field
            ,done:function (res) {
                layer.msg('成功')
            }
