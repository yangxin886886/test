<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"D:\phpstudy\PHPTutorial\wwww\git/application/admin\view\menu\menu_add_view.html";i:1562828645;s:82:"D:\phpstudy\PHPTutorial\wwww\git\application\admin\view\public\head_resources.html";i:1563868278;s:84:"D:\phpstudy\PHPTutorial\wwww\git\application\admin\view\public\bottom_resources.html";i:1563266818;s:87:"D:\phpstudy\PHPTutorial\wwww\git\application\admin\view\modules\menu\menu_add_view.html";i:1562829547;}*/ ?>
...
<body>
  ...
  <div class="layui-form" lay-filter="layuiadmin-form-admin" id="layuiadmin-form-admin" style="padding: 20px 30px 0 0;">
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="sort"  value="1" lay-verify="number"  placeholder="1-20菜单位置" autocomplete="off" class="layui-input">
      </div>
    </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="icon"  placeholder="layui图标" autocomplete="off" class="layui-input">
      </div>
    </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="ctl"  placeholder="控制器名称" autocomplete="off" class="layui-input">
      </div>
    </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="act" placeholder="动作名称" autocomplete="off" class="layui-input">
      </div>
    </div>
