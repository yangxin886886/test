<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\phpstudy\PHPTutorial\wwww\git/application/admin\view\role\index.html";i:1565349738;s:82:"D:\phpstudy\PHPTutorial\wwww\git\application\admin\view\public\head_resources.html";i:1563868278;s:84:"D:\phpstudy\PHPTutorial\wwww\git\application\admin\view\public\bottom_resources.html";i:1563266818;s:79:"D:\phpstudy\PHPTutorial\wwww\git\application\admin\view\modules\role\index.html";i:1565348952;}*/ ?>
...
<!--          <button class="layui-btn layuiadmin-btn-role" data-type="batchdel">删除</button>-->
        ...
        <script type="text/html" id="is_default_role">
            {{#  if(d.is_default_role == 1){ }}
            <a class="layui-btn " lay-event="is_default_role">是</a>
            {{#  } else { }}
            <a class="layui-btn layui-btn-danger" lay-event="is_default_role">否</a>
            {{#  } }}
        </script>
  ...
  layui.config({
    ...
    var $ = layui.$
      ...
      table.render({
          ...
          ,cols: [[ //表头
              ...
              ,{field: 'is_default_role', title: '是否是默认角色',templet:'#is_default_role'}
    ...
    form.on('select(role_select)',function (data) {
      ...
      table.on('tool(roleIndex)', function(obj){
          ...
          else if(layEvent === 'is_default_role'){
              var default_url = "<?php echo url('Role/setDefaultRole'); ?>";
              layer.confirm('确认操作', function(index){
                  admin.req({
                      url:default_url,
                      data:{id:data.id,is_default_role:data.is_default_role},
                      done: function (res) {
                          layer.msg('成功');
